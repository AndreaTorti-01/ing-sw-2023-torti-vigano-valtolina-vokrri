...
/**
 * Controller for the second player's shelf.
 */
public class Shelf1Controller implements Initializable {
    /**
            ...
            for (int row = 0; row < numberOfRows; row++) {
                for (int col = 0; col < numberOfColumns; col++) {
                    if (newShelf[row][col] != null) {
                        ...
                        ImageView imageView = (ImageView) shelf1.getChildren().get(col * numberOfRows + row);
